                                ...
                                <div class="sidebar-holder">
                                    ...
                                    <div class="single-sidebar-box mt-30 wow fadeInUp animated">
                                        ...
                                        <ul class="color-option">
                                            ...
                                            <a @click.prevent="addColor(color.id)" href="#0" class="color-option-single" :style="`background: #${color.title}`"> <span>{{ color.title }}</span> </a> </li>
                                        </ul>
                                    </div>
                                    <div class="single-sidebar-box mt-30 wow fadeInUp animated">
                                                                ...
                                                                <div class="row justify-content-between align-items-center">
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="popup-right-content">
                                                                            ...
                                                                            <div class="price">
                                                                                <h2> ${{ popupProduct.price }} USD <del> ${{ popupProduct.old_price }} USD</del></h2>
                                                                                <h6> In stuck</h6>
                                                                            </div>
